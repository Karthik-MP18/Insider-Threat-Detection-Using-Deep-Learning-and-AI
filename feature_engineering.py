...
common_job_sites = ['job', 'career', 'linkedin', 'indeed', 'glassdoor', 'monster', 'ziprecruiter', 'workday', 'hired', 'careerbuilder', 
    'simplyhired', 'naukri', 'rozee', 'bayt', 'dice', 'craigslist', 'snagajob', 'upwork', 'freelancer', 'fiverr']
